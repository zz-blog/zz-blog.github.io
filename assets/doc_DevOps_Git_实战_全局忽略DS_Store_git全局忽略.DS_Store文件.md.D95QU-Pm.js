import{_ as s,c as n,o as a,a5 as p}from"./chunks/framework.DwbewbAn.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"doc/DevOps/Git/实战/全局忽略DS_Store/git全局忽略.DS_Store文件.md","filePath":"packages/doc/src/DevOps/Git/实战/全局忽略DS_Store/git全局忽略.DS_Store文件.md","lastUpdated":1704208495000}'),e={name:"doc/DevOps/Git/实战/全局忽略DS_Store/git全局忽略.DS_Store文件.md"},l=p(`<p><strong>让 Git 全局性的忽略 .DS_Store</strong></p><p>Mac中每个目录都会有个文件叫.DS_Store,用于存储当前文件夹的一些Meta信息。每次提交代码时，我都要在代码仓库的.gitignore中声明，忽略这类文件。有方法可以全局性的忽略某种类型的文件吗？</p><p><strong>按照以下两步就可实现</strong></p><p>1.创建~/.gitignore_global文件，把需要全局忽略的文件类型塞到这个文件里。</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># .gitignore_global</span></span>

import{_ as a,c as e,l as s,a as p,t as l,a4 as i,o as t}from"./chunks/framework.CzsDe1xi.js";const g=JSON.parse('{"title":"声明式JenkinsFile详解","description":"","frontmatter":{"title":"声明式JenkinsFile详解"},"headers":[],"relativePath":"doc/DevOps/Jenkins/基础/脚本式语法.md","filePath":"packages/doc/src/DevOps/Jenkins/基础/脚本式语法.md","lastUpdated":1704107537000}'),r={name:"doc/DevOps/Jenkins/基础/脚本式语法.md"},c={id:"frontmatter-title",tabindex:"-1"},o=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),b=i(`<ul><li><a href="https://www.jenkins.io/doc/book/pipeline/syntax/" target="_blank" rel="noreferrer">pipeline syntax</a></li></ul><h2 id="特点" tabindex="-1">特点 <a class="header-anchor" href="#特点" aria-label="Permalink to &quot;特点&quot;">​</a></h2><ul><li>以Groovy语言为基础，语法结构同Groovy相同</li><li>脚本化提供了很少的限制, 限制往往是由Groovy子集本身定义的，而不是任何特定于流水线的系统</li><li>高级用户和那些有更复杂需求的人的理想选择</li></ul><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>node {</span></span>

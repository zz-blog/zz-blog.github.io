import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.1b6086f5.js";const E=JSON.parse('{"title":"type assert","description":null,"frontmatter":{"lang":"zh-CN","title":"type assert","description":null},"headers":[],"relativePath":"doc/编程语言/Go/基础/type/typeAssert.md","filePath":"packages/doc/src/编程语言/Go/基础/type/typeAssert.md","lastUpdated":1704297641000}'),l={name:"doc/编程语言/Go/基础/type/typeAssert.md"},e=p(`<h1 id="type-assert-类型断言" tabindex="-1">type assert 类型断言 <a class="header-anchor" href="#type-assert-类型断言" aria-label="Permalink to &quot;type assert 类型断言&quot;">​</a></h1><p>类型断言被用于检查接口类型变量所持有的值是否实现了期望的接口或者具体的类型。</p><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">类型断言的语法定义如下：</span></span>

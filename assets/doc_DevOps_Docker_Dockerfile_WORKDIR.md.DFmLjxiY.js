import{_ as n,c as e,l as s,a as p,t as l,a4 as t,o as r}from"./chunks/framework.CzsDe1xi.js";const I=JSON.parse('{"title":"WORKDIR","description":"","frontmatter":{"title":"WORKDIR"},"headers":[],"relativePath":"doc/DevOps/Docker/Dockerfile/WORKDIR.md","filePath":"packages/doc/src/DevOps/Docker/Dockerfile/WORKDIR.md","lastUpdated":1705850916000}'),i={name:"doc/DevOps/Docker/Dockerfile/WORKDIR.md"},c={id:"frontmatter-title",tabindex:"-1"},o=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),d=t(`<div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1.Dockerfile中的WORKDIR指令用于指定容器的一个目录， 容器启动时执行的命令会在该目录下执行。</span></span>

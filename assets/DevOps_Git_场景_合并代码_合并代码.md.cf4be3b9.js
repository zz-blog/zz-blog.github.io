import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.6d94f49f.js";const E=JSON.parse('{"title":"合并代码","description":null,"frontmatter":{"lang":"zh-CN","title":"合并代码","description":null},"headers":[],"relativePath":"DevOps/Git/场景/合并代码/合并代码.md","filePath":"DevOps/Git/场景/合并代码/合并代码.md","lastUpdated":1700671655000}'),p={name:"DevOps/Git/场景/合并代码/合并代码.md"},e=l(`<h1 id="合并代码" tabindex="-1">合并代码 <a class="header-anchor" href="#合并代码" aria-label="Permalink to &quot;合并代码&quot;">​</a></h1><h3 id="合并多个commit" tabindex="-1">合并多个commit <a class="header-anchor" href="#合并多个commit" aria-label="Permalink to &quot;合并多个commit&quot;">​</a></h3><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 这个命令，将最近4个commit合并为1个，HEAD代表当前版本。</span></span>

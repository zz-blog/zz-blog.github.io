import{_ as s,c as n,o as a,U as e}from"./chunks/framework.9QHaLlVJ.js";const _=JSON.parse('{"title":"auto.cnf","description":"","frontmatter":{},"headers":[],"relativePath":"doc/数据库/Mysql/问题/auto.cnf文件.md","filePath":"packages/doc/src/数据库/Mysql/问题/auto.cnf文件.md","lastUpdated":1702458087000}'),p={name:"doc/数据库/Mysql/问题/auto.cnf文件.md"},l=e(`<h1 id="auto-cnf" tabindex="-1">auto.cnf <a class="header-anchor" href="#auto-cnf" aria-label="Permalink to &quot;auto.cnf&quot;">​</a></h1><h2 id="_1-auto-cnf文件" tabindex="-1">1.auto.cnf文件 <a class="header-anchor" href="#_1-auto-cnf文件" aria-label="Permalink to &quot;1.auto.cnf文件&quot;">​</a></h2><p>MySQL数据目录中通常存在一个名为auto.cnf文件，存储了server-uuid的值，如下所示：</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[auto]</span></span>

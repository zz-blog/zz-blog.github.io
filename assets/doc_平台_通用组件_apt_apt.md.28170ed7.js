import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.3daba8ea.js";const E=JSON.parse('{"title":"apt 常用命令","description":"","frontmatter":{},"headers":[],"relativePath":"doc/平台/通用组件/apt/apt.md","filePath":"packages/doc/src/平台/通用组件/apt/apt.md","lastUpdated":1704615314000}'),l={name:"doc/平台/通用组件/apt/apt.md"},e=p(`<h1 id="apt-常用命令" tabindex="-1">apt 常用命令 <a class="header-anchor" href="#apt-常用命令" aria-label="Permalink to &quot;apt 常用命令&quot;">​</a></h1><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 查看包详情</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 查看损坏的依赖</span></span>
<span class="line"><span style="color:#6F42C1;">apt-get</span><span style="color:#24292E;"> </span><span style="color:#032F62;">check</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div>`,2),o=[e];function t(c,r,i,d,y,h){return a(),n("div",null,o)}const b=s(l,[["render",t]]);export{E as __pageData,b as default};

import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.6d94f49f.js";const y=JSON.parse('{"title":"channel","description":null,"frontmatter":{"lang":"zh-CN","title":"channel","description":null},"headers":[],"relativePath":"编程语言/Go/知识点/channel/channel.md","filePath":"编程语言/Go/知识点/channel/channel.md","lastUpdated":1700319152000}'),l={name:"编程语言/Go/知识点/channel/channel.md"},p=a(`<div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">type hchan struct {</span></span>

import{_ as e,o as n,c as l,k as s,a as p,t,Q as o}from"./chunks/framework.3daba8ea.js";const g=JSON.parse('{"title":"声明式语法","description":"","frontmatter":{"title":"声明式语法"},"headers":[],"relativePath":"doc/DevOps/Jenkins/基础/声明式语法.md","filePath":"packages/doc/src/DevOps/Jenkins/基础/声明式语法.md","lastUpdated":1704107537000}'),r={name:"doc/DevOps/Jenkins/基础/声明式语法.md"},c={id:"frontmatter-title",tabindex:"-1"},i=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),d=o(`<ul><li><a href="https://www.jenkins.io/doc/book/pipeline/syntax/" target="_blank" rel="noreferrer">pipeline syntax</a></li></ul><h2 id="特点" tabindex="-1">特点 <a class="header-anchor" href="#特点" aria-label="Permalink to &quot;特点&quot;">​</a></h2><ul><li>更简单、更有主见的语法</li><li>限制了用户使用更严格和预定义的结构， 但是略显繁琐</li></ul><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">pipeline {</span></span>

import{_ as n,c as i,l as s,a as l,t as e,a4 as p,o as r}from"./chunks/framework.CzsDe1xi.js";const y=JSON.parse('{"title":"cargo","description":"","frontmatter":{"title":"cargo"},"headers":[],"relativePath":"doc/编程语言/后端/Rust/环境搭建/cargo.md","filePath":"packages/doc/src/编程语言/后端/Rust/环境搭建/cargo.md","lastUpdated":1711551906000}'),t={name:"doc/编程语言/后端/Rust/环境搭建/cargo.md"},h={id:"frontmatter-title",tabindex:"-1"},c=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),k=p(`<p>rust 的构建工具和包管理器</p><h2 id="常用命令" tabindex="-1">常用命令 <a class="header-anchor" href="#常用命令" aria-label="Permalink to &quot;常用命令&quot;">​</a></h2><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 可以构建项目</span></span>

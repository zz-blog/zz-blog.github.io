import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.3daba8ea.js";const E=JSON.parse('{"title":"apt 常用命令","description":"","frontmatter":{},"headers":[],"relativePath":"doc/平台/组件/apt/apt.md","filePath":"packages/doc/src/平台/组件/apt/apt.md","lastUpdated":1702485246000}'),l={name:"doc/平台/组件/apt/apt.md"},e=p(`<h1 id="apt-常用命令" tabindex="-1">apt 常用命令 <a class="header-anchor" href="#apt-常用命令" aria-label="Permalink to &quot;apt 常用命令&quot;">​</a></h1><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 查看包详情</span></span>

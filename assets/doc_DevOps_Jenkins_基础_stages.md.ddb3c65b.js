import{_ as n,o as e,c as l,k as s,a as p,t,Q as o}from"./chunks/framework.1b6086f5.js";const h=JSON.parse('{"title":"stages","description":"","frontmatter":{"title":"stages"},"headers":[],"relativePath":"doc/DevOps/Jenkins/基础/stages.md","filePath":"packages/doc/src/DevOps/Jenkins/基础/stages.md","lastUpdated":1704107537000}'),r={name:"doc/DevOps/Jenkins/基础/stages.md"},c={id:"frontmatter-title",tabindex:"-1"},i=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),E=o(`<ul><li><a href="https://www.jenkins.io/doc/book/pipeline/syntax/#stages" target="_blank" rel="noreferrer">stages</a></li></ul><div class="language-groovy vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">pipeline {</span></span>

import{_ as n,o as e,c as l,k as s,a as p,t,Q as o}from"./chunks/framework.1b6086f5.js";const u=JSON.parse('{"title":"stage","description":"","frontmatter":{"title":"stage"},"headers":[],"relativePath":"doc/DevOps/Jenkins/基础/stage.md","filePath":"packages/doc/src/DevOps/Jenkins/基础/stage.md","lastUpdated":1704107537000}'),r={name:"doc/DevOps/Jenkins/基础/stage.md"},c={id:"frontmatter-title",tabindex:"-1"},i=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),E=o(`<ul><li><a href="https://www.jenkins.io/doc/book/pipeline/syntax/#stage" target="_blank" rel="noreferrer">stage</a></li></ul><h2 id="stage" tabindex="-1">stage <a class="header-anchor" href="#stage" aria-label="Permalink to &quot;stage&quot;">​</a></h2><p>内部包含一个或者多个steps</p><div class="language-groovy vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">groovy</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">pipeline {</span></span>

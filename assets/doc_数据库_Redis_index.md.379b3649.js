import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.1b6086f5.js";const h=JSON.parse('{"title":"REDIS知识点总结","description":null,"frontmatter":{"lang":"zh-CN","title":"REDIS知识点总结","description":null},"headers":[],"relativePath":"doc/数据库/Redis/index.md","filePath":"packages/doc/src/数据库/Redis/index.md","lastUpdated":1702458087000}'),l={name:"doc/数据库/Redis/index.md"},p=e(`<h1 id="redis知识点总结" tabindex="-1">Redis知识点总结 <a class="header-anchor" href="#redis知识点总结" aria-label="Permalink to &quot;Redis知识点总结&quot;">​</a></h1><ul><li><a href="https://redis.io/" target="_blank" rel="noreferrer">官网</a></li><li><a href="https://redis.io/documentation" target="_blank" rel="noreferrer">文档地址</a></li><li><a href="https://developer.redis.com/" target="_blank" rel="noreferrer">https://developer.redis.com/</a></li><li><a href="https://blog.csdn.net/androidlushangderen/category_9263229.html" target="_blank" rel="noreferrer">https://blog.csdn.net/androidlushangderen/category_9263229.html</a></li></ul><h1 id="基础" tabindex="-1">基础 <a class="header-anchor" href="#基础" aria-label="Permalink to &quot;基础&quot;">​</a></h1><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">1.数据类型</span></span>

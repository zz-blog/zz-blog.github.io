import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.1b6086f5.js";const d=JSON.parse('{"title":"k8s 批量设置label","description":"","frontmatter":{},"headers":[],"relativePath":"doc/编程语言/Shell/工具脚本/k8s/批量设置label.md","filePath":"packages/doc/src/编程语言/Shell/工具脚本/k8s/批量设置label.md","lastUpdated":1702570157000}'),e={name:"doc/编程语言/Shell/工具脚本/k8s/批量设置label.md"},p=l(`<h1 id="k8s-批量设置label" tabindex="-1">k8s 批量设置label <a class="header-anchor" href="#k8s-批量设置label" aria-label="Permalink to &quot;k8s 批量设置label&quot;">​</a></h1><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">cat</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&gt;&gt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">k8sSetLables.sh</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&lt;&lt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">EOF</span></span>

import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.CzsDe1xi.js";const m=JSON.parse('{"title":"type assert","description":null,"frontmatter":{"lang":"zh-CN","title":"type assert","description":null},"headers":[],"relativePath":"doc/编程语言/后端/Go/基础/type/typeAssert.md","filePath":"packages/doc/src/编程语言/后端/Go/基础/type/typeAssert.md","lastUpdated":1711551906000}'),i={name:"doc/编程语言/后端/Go/基础/type/typeAssert.md"},l=p(`<h1 id="type-assert-类型断言" tabindex="-1">type assert 类型断言 <a class="header-anchor" href="#type-assert-类型断言" aria-label="Permalink to &quot;type assert 类型断言&quot;">​</a></h1><p>类型断言被用于检查接口类型变量所持有的值是否实现了期望的接口或者具体的类型。</p><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>类型断言的语法定义如下：</span></span>

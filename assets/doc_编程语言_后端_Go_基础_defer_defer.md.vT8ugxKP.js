import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.CzsDe1xi.js";const f=JSON.parse('{"title":"defer","description":null,"frontmatter":{"lang":"zh-CN","title":"defer","description":null},"headers":[],"relativePath":"doc/编程语言/后端/Go/基础/defer/defer.md","filePath":"packages/doc/src/编程语言/后端/Go/基础/defer/defer.md","lastUpdated":1711551906000}'),l={name:"doc/编程语言/后端/Go/基础/defer/defer.md"},e=p(`<h1 id="defer" tabindex="-1">defer <a class="header-anchor" href="#defer" aria-label="Permalink to &quot;defer&quot;">​</a></h1><p>延迟执行语句,设计之初的目的用来在函数返回之后，做一些释放资源的操作。</p><p>特点:</p><ul><li>符合栈的特点，先定义的defer语句后执行</li><li>调用的时机可以是函数正常结束时，也可以是发生宕机时，go自身有机制保障defer语句被最终调用(panic时候也可以保证调用)</li></ul><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><div class="language-text vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>

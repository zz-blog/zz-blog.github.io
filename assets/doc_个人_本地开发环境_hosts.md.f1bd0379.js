import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.3daba8ea.js";const E=JSON.parse('{"title":"添加hosts","description":"","frontmatter":{"order":1},"headers":[],"relativePath":"doc/个人/本地开发环境/hosts.md","filePath":"packages/doc/src/个人/本地开发环境/hosts.md","lastUpdated":1704107537000}'),p={name:"doc/个人/本地开发环境/hosts.md"},e=l(`<h1 id="添加hosts" tabindex="-1">添加hosts <a class="header-anchor" href="#添加hosts" aria-label="Permalink to &quot;添加hosts&quot;">​</a></h1><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">cat</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&gt;&gt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">/etc/hosts</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&lt;&lt;</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">EOF</span></span>
...
<span class="line"><span style="color:#9ECBFF;">192.168.200.12 k8s-devops</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#032F62;">192.168.200.12 k8s-devops</span></span>
<span class="line"></span>
